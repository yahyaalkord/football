...
class SaffSignUpScreen extends StatefulWidget {
  const SaffSignUpScreen({Key? key}) : super(key: key);

  @override
  State<SaffSignUpScreen> createState() => _SaffSignUpScreenState();
}

class _SaffSignUpScreenState extends State<SaffSignUpScreen> {
